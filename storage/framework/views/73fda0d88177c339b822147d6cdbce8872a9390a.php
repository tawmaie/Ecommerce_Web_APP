...
<body id="ismk"><div id="isey" class="gjs-row"><div class="gjs-cell"></div></div><div id="i6fg" class="gjs-row"><div id="iw1f" class="gjs-cell"></div><div class="gjs-cell"></div></div><div id="imjp" class="gjs-row"><div class="gjs-cell"></div><div class="gjs-cell"><?php echo $__env->yieldContent(&#039;products&#039;); ?>
                </div><div class="gjs-cell"></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/05089ddf1486e7a23d413e3392f4471013b3aab7.blade.php ENDPATH**/ ?>