...
<body id="impd"><div id="ibn5">Welcome to our shop.</div><div class="gjs-row" id="iw7n"><div class="gjs-cell" id="iugf">@yield('categories')</div><div class="gjs-cell" id="izr4">@yield('products')</div></div></body>@endsection
