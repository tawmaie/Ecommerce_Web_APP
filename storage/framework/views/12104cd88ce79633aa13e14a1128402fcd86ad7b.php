...
<body id="ismk"><div class="gjs-row" id="iz2i"><div class="gjs-cell"></div></div><div class="gjs-row" id="iacd"><div class="gjs-cell"></div><div class="gjs-cell"></div></div><div class="gjs-row" id="ivsl"><div class="gjs-cell"></div><div class="gjs-cell"><?php echo $__env->yieldContent('products'); ?>
                </div><div class="gjs-cell"></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/69687beaf1a191fc0df4176a77746fa6369cfe5e.blade.php ENDPATH**/ ?>