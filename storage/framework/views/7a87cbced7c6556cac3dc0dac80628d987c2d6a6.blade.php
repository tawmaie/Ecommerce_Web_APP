...
@endsection
    @section('content')
<body id="ismk"><div class="gjs-row" id="iz2i"><div class="gjs-cell"></div></div><div class="gjs-row" id="iacd"><div class="gjs-cell"></div><div class="gjs-cell"></div></div><div class="gjs-row" id="ivsl"><div class="gjs-cell"></div><div class="gjs-cell">@section('products')
