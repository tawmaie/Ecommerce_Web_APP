...
<body><div class="gjs-row" id="imqo"><div class="gjs-cell"></div><div class="gjs-cell"></div></div><div class="gjs-row" id="i2fh"><div class="gjs-cell"><div class="card"><div class="card-header bg-primary text-white text-uppercase"> Categories </div><ul class="list-group">
                                ...
                                @endforeach
                            </ul></div></div><div class="gjs-cell"><div id="ir9kx">@yield('products')</div></div><div class="gjs-cell"></div></div><div class="gjs-row" id="i10q"><div class="gjs-cell"></div><div class="gjs-cell"></div><div class="gjs-cell"></div></div></body>@endsection
