...
<body id="impd"><div id="ibn5">Welcome to our shop.</div><div class="gjs-row" id="imq8"><div class="gjs-cell"><?php echo $__env->yieldContent('categories2'); ?></div></div><div id="iw7n" class="gjs-row"><div id="izr4" class="gjs-cell"><?php echo $__env->yieldContent('products'); ?></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/9051839e6624f4c83c2a633ba85723ee6f3b68a4.blade.php ENDPATH**/ ?>