...
<body id="impd"><div id="imqo" class="gjs-row"><div id="ipbj" class="gjs-cell"><div id="ihkxj">Welcome to our shop</div></div></div><div id="i2fh" class="gjs-row"><div id="icei" class="gjs-cell"><div class="card"></div><div id="isa6m"><?php echo $__env->yieldContent('categories'); ?></div><div id="iegj1"><?php echo $__env->yieldContent('products'); ?></div></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/4b77260f80ff97c5b84cbdf3bd4b2c1dd14770c1.blade.php ENDPATH**/ ?>