...
<style>.gjs-row{display:table;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;}.gjs-cell{width:8%;display:table-cell;height:75px;}#i3c3{width:30%;}#i9ny{width:70%;}@media(max-width: 768px){.gjs-cell{width:100%;display:block;}}</style>
<body id="i5aq"><div class="gjs-row" id="idsm"><div class="gjs-cell" id="i3c3"><?php echo $__env->yieldContent('categories'); ?></div><div class="gjs-cell" id="i9ny"><?php echo $__env->yieldContent('products'); ?></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/f3d07620e2b2307c249022b09d8b5f2769ef66a2.blade.php ENDPATH**/ ?>