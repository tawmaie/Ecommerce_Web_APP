...
@endsection
    @section('content')
<body id="impd"><div id="imqo" class="gjs-row"><div class="gjs-cell"><div id="isngy">@yield('products')</div></div><div class="gjs-cell"></div></div><div id="i2fh" class="gjs-row"><div id="icei" class="gjs-cell"><div class="card"></div><div id="isa6m">@yield('categories')</div></div><div class="gjs-cell" id="iw2c"></div></div></body>@endsection
