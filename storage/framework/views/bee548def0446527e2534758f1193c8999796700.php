...
<style>.gjs-row{display:table;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;}.gjs-cell{width:8%;display:table-cell;height:75px;}#iae1{width:30%;}#ip1j{width:70%;}@media(max-width: 768px){.gjs-cell{width:100%;display:block;}}</style>
<body id="i5aq"><div class="gjs-row" id="iisc"><div class="gjs-cell" id="iae1"><?php echo $__env->yieldContent('categories'); ?></div><div class="gjs-cell" id="ip1j"><?php echo $__env->yieldContent('products'); ?></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/a15384a9f0ab7e685fdd7f303bf9f7a7ecc31d56.blade.php ENDPATH**/ ?>