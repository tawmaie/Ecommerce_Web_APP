...
<body id="ismk"><div class="gjs-row" id="iz2i"><div class="gjs-cell"></div></div><div class="gjs-row" id="iacd"><div class="gjs-cell"></div><div class="gjs-cell"></div></div><div class="gjs-row" id="ivsl"><div class="gjs-cell"></div><div class="gjs-cell"><?php $__env->startSection('products'); ?>
                </div><div class="gjs-cell"></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/7a87cbced7c6556cac3dc0dac80628d987c2d6a6.blade.php ENDPATH**/ ?>