                                ...
                                <?php $__currentLoopData = range(1, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="carousel-item active">
                                        <a href="<?php echo e(route('product')); ?>">
                                            <img src="<?php echo e(asset('images/promotion-sm.jpg')); ?>" class="d-block"
                                                alt="...">
                                        </a>
                                    </div>
                    ...
                    <?php $__currentLoopData = range(1, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4 col-sm-6 mt-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title"><a href="<?php echo e(route('product')); ?>"
                                            title="View Product">Product<?php echo e($i); ?></a></h4>
                                    <div class="row">
                                        <div class="col">
...
<?php echo $__env->make('layouts.owner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\resources\views/Home/Custom/HomeCustom.blade.php ENDPATH**/ ?>