...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card my-4">
        ...
        <div class="card-body">
            <form action=" <?php echo e(route('shops.product.store', (array) Route::current()->parameters())); ?> " method="post"
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" id="type_id" name="type_id">
                        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type->getKey()); ?>" <?php if(old('type_id') == $type->getKey()): echo 'selected'; endif; ?>><?php echo e($type->name); ?></option>
                ...
                <a href="<?php echo e(route('shops.product.index', [...((array) Route::current()->parameters())])); ?>"
...
<?php echo $__env->make('layouts.owner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\resources\views/product/create.blade.php ENDPATH**/ ?>