...
@endsection
    @section('content')
<body id="i5aq"><div id="i4i5" class="gjs-row"><div id="i9jb" class="gjs-cell"><div id="ijfx">@yield('categories')</div></div><div id="ilq2" class="gjs-cell"><div id="ie2e">@yield('products')</div></div></div></body>@endsection
