...
<style>.gjs-cell { vertical-align: top; }.gjs-row{display:table;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;}.gjs-cell{width:8%;display:table-cell;height:75px;}#impd{background-color:#9f7575;}#ibn5{padding:10px;font-size:50px;}#iugf{width:30%;}#izr4{width:70%;padding:20px 20px 20px 20px;}@media(max-width: 768px){.gjs-cell{width:100%;display:block;}}</style>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/0afa3afe51baba1d48f0018042900c7e34b7b823.blade.php ENDPATH**/ ?>