...
@endsection
    @section('content')
<body id="ismk"><div id="isey" class="gjs-row"><div class="gjs-cell"></div></div><div id="i6fg" class="gjs-row"><div id="iw1f" class="gjs-cell"></div><div class="gjs-cell"></div></div><div id="imjp" class="gjs-row"><div class="gjs-cell"></div><div class="gjs-cell">@yield(&#039;products&#039;)
