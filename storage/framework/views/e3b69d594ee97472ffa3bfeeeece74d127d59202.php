...
<style>.gjs-cell { vertical-align: top; }.gjs-row{display:table;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;}.gjs-cell{width:8%;display:table-cell;height:75px;}#impd{background-color:#9f7575;}#ibn5{padding:10px;}#iugf{width:30%;}#izr4{width:70%;}@media(max-width: 768px){.gjs-cell{width:100%;display:block;}}</style>
<body id="impd"><div id="ibn5">Welcome to our shop.</div><div class="gjs-row" id="iw7n"><div class="gjs-cell" id="iugf"><?php echo $__env->yieldContent('categories'); ?></div><div class="gjs-cell" id="izr4"><?php echo $__env->yieldContent('products'); ?></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/82f086b22f01f16fff26745b2844b3b9968b11fb.blade.php ENDPATH**/ ?>