...
@endsection
    @section('content')
<style><body id="impd"><div id="imqo" class="gjs-row"><div id="ipbj" class="gjs-cell"><div id="ihkxj">Welcome to our shop</div></div></div><div id="i2fh" class="gjs-row"><div id="icei" class="gjs-cell"><div class="card"></div><x-yield id="iqfps">products</x-yield></div></div><div class="gjs-row" id="iclzq"><div class="gjs-cell"><x-yield id="ikeee">categories</x-yield></div></div></body></style>
<body id="impd"><div id="imqo" class="gjs-row"><div id="ipbj" class="gjs-cell"><div id="ihkxj">Welcome to our shop</div></div></div><div id="i2fh" class="gjs-row"><div id="icei" class="gjs-cell"><div class="card"></div><x-yield id="iqfps">products</x-yield></div></div><div class="gjs-row" id="iclzq"><div class="gjs-cell"><x-yield id="ikeee">categories</x-yield></div></div></body>@endsection
