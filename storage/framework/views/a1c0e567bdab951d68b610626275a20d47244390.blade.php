...
@endsection
    @section('content')
<body id="impd"><div id="imqo" class="gjs-row"><div class="gjs-cell" id="ipbj"><div id="ihkxj">Welcome to our shop</div></div></div><div id="i2fh" class="gjs-row"><div id="icei" class="gjs-cell"><div class="card"></div><div id="isa6m">@yield('categories')</div></div><div id="iw2c" class="gjs-cell"><div id="iegj1">@yield('products')</div></div></div></body>@endsection
