...
@endsection
    @section('content')
<body id="ismk"><div id="iz2i" class="gjs-row"><div class="gjs-cell"></div></div><div id="iacd" class="gjs-row"><div class="gjs-cell"></div><div class="gjs-cell"></div></div><div class="gjs-row" id="i9kh"><div class="gjs-cell"></div><div class="gjs-cell">@yield('products')
