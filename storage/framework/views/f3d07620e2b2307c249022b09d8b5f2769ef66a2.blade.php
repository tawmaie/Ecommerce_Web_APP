...
<body id="i5aq"><div class="gjs-row" id="idsm"><div class="gjs-cell" id="i3c3">@yield('categories')</div><div class="gjs-cell" id="i9ny">@yield('products')</div></div></body>@endsection
