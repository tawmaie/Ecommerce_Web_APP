...
<body id="impd"><div id="imqo" class="gjs-row"><div id="ipbj" class="gjs-cell"><div id="ihkxj">Welcome to our shop</div></div></div><div id="i2fh" class="gjs-row"><div id="icei" class="gjs-cell"><div class="card"></div>@yield('products')</div></div><div class="gjs-row" id="iclzq"><div class="gjs-cell">@yield('categories')</div></div></body>@endsection
