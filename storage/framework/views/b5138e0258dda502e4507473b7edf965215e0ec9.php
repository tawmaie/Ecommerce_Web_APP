    ...
    <div class="card bg-light mb-3">
        ...
        <ul class="list-group category_block">
            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="list-group-item"><a href="<?php echo e(route('listbytypeshop',[$shop->id, $type->id])); ?>"><?php echo e($type->name); ?></a></li>
...
<?php $__env->startSection('categories2'); ?>
    <div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3 mt-1">
        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
                <a href="<?php echo e(route('listbytypeshop',[$shop->id, $type->id])); ?>"><div class="p-3 border bg-light" style="border-radius: 20px" ><?php echo e($type->name); ?></div></a>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
<?php $__env->stopSection(); ?>
...
<style>.gjs-cell { vertical-align: top; }.gjs-row{display:table;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;}.gjs-cell{width:8%;display:table-cell;height:75px;}#i90k{width:30%;padding:16px 16px 16px 16px;}#i7xf{width:70%;}@media(max-width: 768px){.gjs-cell{width:100%;display:block;}}</style>
<body id="i5aq"><div class="gjs-row" id="iom3"><div class="gjs-cell" id="i90k"><?php echo $__env->yieldContent('categories'); ?></div><div class="gjs-cell" id="i7xf"><?php echo $__env->yieldContent('products'); ?></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/0f3687dfaf080c8ab229ac41238f967d9e337e84.blade.php ENDPATH**/ ?>