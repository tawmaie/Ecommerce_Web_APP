...
<body id="i5aq"><div id="i4i5" class="gjs-row"><div id="i9jb" class="gjs-cell"><div id="ijfx"><?php echo $__env->yieldContent('categories'); ?></div></div><div id="ilq2" class="gjs-cell"><div id="ie2e"><?php echo $__env->yieldContent('products'); ?></div></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/9027455f3487e5c35fc2bd10e50f25b0f56581d4.blade.php ENDPATH**/ ?>