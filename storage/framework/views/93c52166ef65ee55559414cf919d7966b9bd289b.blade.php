...
<body id="i5aq"><div class="gjs-row" id="iom3"><div class="gjs-cell" id="i90k">@yield('categories')</div><div class="gjs-cell" id="i7xf">@yield('products')</div></div></body>@endsection
