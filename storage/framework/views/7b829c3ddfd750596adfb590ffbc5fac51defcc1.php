...
<body><div id="imqo" class="gjs-row"><div class="gjs-cell"></div><div class="gjs-cell"></div></div><div id="i2fh" class="gjs-row"><div id="icei" class="gjs-cell"><div class="card"></div><div id="isa6m"><?php echo $__env->yieldContent('categories'); ?></div></div><div class="gjs-cell"><div id="ir9kx"><?php echo $__env->yieldContent('products'); ?></div></div></div><div id="i10q" class="gjs-row"><div class="gjs-cell"></div><div class="gjs-cell"></div><div class="gjs-cell"></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/a77cc16ab6d472844f633cca89e06b29fd751aa5.blade.php ENDPATH**/ ?>