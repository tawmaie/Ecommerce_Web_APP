...
@endsection
    @section('content')
<body><div id="imqo" class="gjs-row"><div class="gjs-cell"></div><div class="gjs-cell"></div></div><div id="i2fh" class="gjs-row"><div id="icei" class="gjs-cell"><div class="card"></div><div id="isa6m">@yield('categories')</div></div><div class="gjs-cell"><div id="ir9kx">@yield('products')</div></div></div><div id="i10q" class="gjs-row"><div class="gjs-cell"></div><div class="gjs-cell"></div><div class="gjs-cell"></div></div></body>@endsection
