...
<style>.gjs-row{display:table;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;}.gjs-cell{width:8%;display:table-cell;height:75px;}#im6t{width:30%;position:relative;top:0;left:0;}#i234{width:70%;}@media(max-width: 768px){.gjs-cell{width:100%;display:block;}}</style>
<body id="i5aq"><div id="i23l" class="gjs-row"><div id="im6t" class="gjs-cell"><?php echo $__env->yieldContent('categories'); ?></div><div id="i234" class="gjs-cell"><?php echo $__env->yieldContent('products'); ?></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/8896545a88ddcb162a1d3d8e5aac6728e91d61c7.blade.php ENDPATH**/ ?>