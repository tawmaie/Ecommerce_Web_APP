  ...
  ?>
    ...
    <div class="row">
      <div class="col-md-4 order-md-2 mb-4">
            ...
            ?>
              <li class="list-group-item d-flex justify-content-between lh-condensed">
                <div>
                  ...
                  <small class="text-muted"><?php echo e($cart['quantity']); ?></small>
                </div>
        ...
        <div class="card p-2">
          <strong>Total <?php echo e($total); ?> baht</strong>
        </div>
      </div>
      <div class="col-md-8 order-md-1">
        <h4 class="mb-3">Billing address</h4>
        <form action=" <?php echo e(route('OrderPlacement')); ?> " method="post" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\resources\views/Order/Summary.blade.php ENDPATH**/ ?>