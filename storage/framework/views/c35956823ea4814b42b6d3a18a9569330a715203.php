...
<body id="impd"><div id="imqo" class="gjs-row"><div class="gjs-cell" id="ipbj"><div id="ihkxj">Welcome to our shop</div></div></div><div id="i2fh" class="gjs-row"><div id="icei" class="gjs-cell"><div class="card"></div><div id="isa6m"><?php echo $__env->yieldContent('categories'); ?></div></div><div id="iw2c" class="gjs-cell"><div id="iegj1"><?php echo $__env->yieldContent('products'); ?></div></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/a1c0e567bdab951d68b610626275a20d47244390.blade.php ENDPATH**/ ?>