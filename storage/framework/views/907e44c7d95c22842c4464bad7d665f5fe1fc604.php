...
<body id="impd"><div id="imqo" class="gjs-row"><div id="ipbj" class="gjs-cell"><div id="ihkxj">Welcome to our shop</div></div></div><div class="gjs-row" id="ifnt"><div class="gjs-cell" id="iqye"><?php echo $__env->yieldContent('categories'); ?></div><div class="gjs-cell" id="iabb"><?php echo $__env->yieldContent('products'); ?></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/61439e5b692c3a9ddc6f2b21e96189b7772d096e.blade.php ENDPATH**/ ?>