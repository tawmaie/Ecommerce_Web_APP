...
<style>.gjs-row{display:table;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;}.gjs-cell{width:8%;display:table-cell;height:75px;}#ihkxj{padding:10px;}#impd{background-color:#9f7575;}@media(max-width: 768px){.gjs-cell{width:100%;display:block;}}</style>
<body id="impd"><div id="imqo" class="gjs-row"><div id="ipbj" class="gjs-cell"><div id="ihkxj">Welcome to our shop</div></div></div><div id="i2fh" class="gjs-row"><div id="icei" class="gjs-cell"><div class="card"></div><?php echo $__env->yieldContent('products'); ?></div></div><div id="iclzq" class="gjs-row"><div class="gjs-cell"><?php echo $__env->yieldContent('categories'); ?></div></div></body><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/62e5b6947d9fb5abebc732b2dcb026fd959c20b8.blade.php ENDPATH**/ ?>