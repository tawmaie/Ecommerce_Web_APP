...
<body id="i5aq"><div class="gjs-row" id="iisc"><div class="gjs-cell" id="iae1">@yield('categories')</div><div class="gjs-cell" id="ip1j">@yield('products')</div></div></body>@endsection
