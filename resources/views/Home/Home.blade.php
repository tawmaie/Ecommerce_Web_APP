        ...
        <div class="container">
            ...
            <ul class="navbar-nav ms-3">
                <li class="nav-item" style="width: 65px;">
                    <a class="nav-link d-flex align-items-center text-white" href="{{ route('cart') }}"><i
                    ...
                    <ul class="list-group category_block">
                        @foreach ($types as $type)
                            <li class="list-group-item"><a
                                    href="{{ route('listbytype', $type->id) }}">{{ $type->name }}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
                    ...
                    @foreach ($products as $product)
                        <div class="col-12 col-md-6 col-lg-4 mt-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title"><a href="{{ route('productDetail', $product->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <a href="{{ route('addtocart', $product->getKey()) }}"
