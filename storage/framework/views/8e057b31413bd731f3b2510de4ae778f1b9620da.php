...
<style>.gjs-cell { vertical-align: top; }.gjs-row{display:table;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;}.gjs-cell{width:8%;display:table-cell;height:75px;}#impd{background-color:#787878;}#ibn5{padding:10px;font-size:50px;color:#efefef;text-align:center;}#iugf{width:30%;}#izr4{width:70%;padding:20px 20px 20px 20px;}@media(max-width: 768px){.gjs-cell{width:100%;display:block;}}</style>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xxamp\htdocs\project\storage\framework\views/e56e5168cd2fd9eb13a4d8bcd9c7c2f4b6154bf1.blade.php ENDPATH**/ ?>